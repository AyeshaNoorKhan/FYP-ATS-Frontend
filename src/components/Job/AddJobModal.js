...
import { Button,Form,Row,Col,InputGroup,FormControl,FloatingLabel } from 'react-bootstrap';
import '../../stylesheet/JobDetail.css';

function AddJobModal(props) {
    return (
        <div className="jobdetail">
            <h4 style={{backgroundColor:"rgb(0, 51, 153)",color:"white",padding:"5px"}} >Add a New Job</h4>
            <p style={{backgroundColor:"gray",color:"white",padding:"3px"}} >Clearly write the decription of job</p>
            <Form >
              
            <Row className="mb-3">
                <Form.Group as={Col} >     
                   <Form.Text className="text-muted">Job ID</Form.Text>
                   <Form.Control size="sm" type="text" name="memberno" placeholder=""  />
                </Form.Group>
                <Form.Group as={Col} >
            ...
            <br/>
               ...
               <br/>
               <Button style={{backgroundColor:"rgb(0, 51, 153)",color:"white",float:"right"}} >
                 Add Job
               </Button>
        </div>
    );
