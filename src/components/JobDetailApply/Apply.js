...
function Apply({ positionApplied }) {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            Axios
                .post("https://atsbackend.herokuapp.com/api/candinfo/addcandinfo", formData,
                    {
                        headers: {
    ...
    return (
        <div>
            <Card style={{ boxShadow: "rgba(0, 0, 0, 0.24) 0px 3px 8px" }}>
                <Card.Header className="careersCardHeader">Apply For This Position</Card.Header>
                <Card.Body style={{ maxHeight: 'calc(100vh - 210px)', overflowY: 'auto' }}>
                    <Form noValidate validated={validated} onSubmit={handleSubmit}>
                        <Form.Group className="mb-3" controlId="formFullName">
                            ...
                            <Form.Control name="cand_name" required type="text" placeholder="Enter Full Name" onChange={setFieldData} />
                            <Form.Control.Feedback type="invalid">Name is required.</Form.Control.Feedback>
                        </Form.Group>

                        <Form.Group className="mb-3" controlId="formEmailAddress">
                            <Form.Label>Email Address<span className="requiredSymbol">*</span></Form.Label>
                            <Form.Control name="cand_email" required type="email" placeholder="name@example.com" onChange={setFieldData} />
                            <Form.Control.Feedback type="invalid">Please enter a valid Email.</Form.Control.Feedback>
                        </Form.Group>

                        <Form.Group className="mb-3" controlId="formMobile">
                            <Form.Label>Mobile<span className="requiredSymbol">*</span></Form.Label>
                            <Form.Control name="cand_contact" required type="tel" placeholder="0XXXXXXXXXX" pattern="[0][0-9]{10}" onChange={setFieldData} />
                        ...
                        <Form.Group className="mb-3" controlId="formCity">
                            <Form.Label>Country<span className="requiredSymbol">*</span></Form.Label>
                        ...
                        <Form.Group className="mb-3" controlId="formGender">
                            ...
                            <div>
                                <Form.Check inline value="Male" label="Male" name="cand_gender" type="radio" required onClick={setFieldData}></Form.Check>
                                <Form.Check inline value="Female" label="Female" name="cand_gender" type="radio" required onClick={setFieldData}></Form.Check>
                            </div>
                        ...
                        <Form.Group className="mb-3" controlId="formShift">
                            ...
                            <Form.Select name="cand_shiftspref" required onChange={setFieldData}>
                        ...
                        <Form.Group className="mb-3" controlId="formGender">
                            <Form.Label>HEC Recognized Degree?<span className="requiredSymbol">*</span></Form.Label>
                            <div>
                                <Form.Check inline value="Yes" label="Yes" name="cand_hecverif" type="radio" required onClick={setFieldData}></Form.Check>
                                <Form.Check inline value="No" label="No" name="cand_hecverif" type="radio" required onClick={setFieldData}></Form.Check>
                            </div>
                        ...
                        <Form.Group className="mb-3" controlId="formExperience">
                            ...
                            <Form.Control name="cand_workexp" required type="number" min="0" max="60" placeholder="Enter Years of Experience (number)" onChange={setFieldData} />
                        ...
                        <Form.Group controlId="formResume" className="mb-3">
                            ...
                            <Form.Control name="cand_Resume" type="file" accept="application/pdf" required onChange={checkFileExt} />
                            <Form.Control.Feedback type="invalid">Resume (pdf) is required.</Form.Control.Feedback>
                            {show ? <Form.Text style={{ color: "#dc3545" }}>Only pdf file is allowed</Form.Text> : null}
                        </Form.Group>

                        <footer className="d-grid">
                            <Button style={{ backgroundColor: "rgb(6, 89, 167)" }} type="submit">Submit Application</Button>
                        </footer>
                    </Form>
                </Card.Body>
            </Card>
